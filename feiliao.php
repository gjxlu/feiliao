...
//user => password
$users = array('zuohaocheng' => '112358', 'gjxlu' => '147055');
...
if ($data['username'] == 'gjxlu') {
  $_REQUEST['name'] = '18771050364';
}
...
<body>
<div id="settings"><a href="settings.php">设置</a></div>
